...
<div class="login-card">
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control" placeholder="email@kampus.ac.id" value="<?php echo e(old('email')); ?>" required autofocus>
        </div>
        <div class="mb-4">
...
<?php /**PATH /Users/holykun/Documents/File PHP Laravel/belajar_php/Layanan Pengaduan/pengaduan-app/resources/views/auth/login.blade.php ENDPATH**/ ?>