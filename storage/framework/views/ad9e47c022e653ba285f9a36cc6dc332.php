<?php $__env->startSection('title', 'Kategori Pengaduan'); ?>
...
<div class="card">
    ...
    <table class="table" id="dataTable">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="data-row">
                <td class="text-muted"><?php echo e($kategoris->firstItem() + $i); ?></td>
                <td class="fw-semibold"><?php echo e($k->nama_kategori); ?></td>
                <td>
                    <div class="d-flex align-items-center gap-2">
                        <span class="d-inline-flex align-items-center justify-content-center rounded"
                            ...
                            <i class="bi bi-<?php echo e($k->ikon ?? 'tag'); ?>"></i>
                        </span>
                        <code style="font-size:11px;color:#64748B;"><?php echo e($k->ikon ?? 'tag'); ?></code>
                    </div>
                </td>
                <td class="text-muted"><?php echo e($k->deskripsi ?? '-'); ?></td>
                <td>
                    <span class="fw-semibold"><?php echo e($k->laporan_count); ?></span>
                    <span class="text-muted" style="font-size:12px;"> laporan</span>
                </td>
                <td>
                    <span class="badge-status <?php echo e($k->status === 'aktif' ? 'badge-aktif' : 'badge-nonaktif'); ?>">
                ...
                <td>
                    <div class="d-flex gap-1">
                        <button class="btn-action edit" onclick="openEdit(<?php echo e($k->id); ?>)">
                            <i class="bi bi-pencil"></i>
                        </button>
                        <button class="btn-action del" onclick="deleteKategori(<?php echo e($k->id); ?>, '<?php echo e(addslashes($k->nama_kategori)); ?>')">
...
<div class="d-flex align-items-center justify-content-between px-4 py-3">
    <small class="text-muted">
        Menampilkan <?php echo e($kategoris->firstItem() ?? 0); ?>–<?php echo e($kategoris->lastItem() ?? 0); ?>

        dari <?php echo e($kategoris->total()); ?> data
    </small>
...
<script>
const BASE_URL = '<?php echo e(route("master.kategori.index")); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/holykun/Documents/File PHP Laravel/belajar_php/Layanan Pengaduan/pengaduan-app/resources/views/master/kategori/index.blade.php ENDPATH**/ ?>