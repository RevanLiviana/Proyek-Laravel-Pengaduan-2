...
<div class="card">
    ...
    <div class="table-responsive table-wrapper">
        <table class="table" id="dataTable">
            ...
            <tbody>
                ...
                <tr class="data-row">
                    <td class="text-muted">{{ $penggunas->firstItem() + $i }}</td>
                    <td>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            ...
                            <button class="btn-action del" onclick="deletePengguna({{ $p->id }}, '{{ addslashes($p->name) }}')"><i class="bi bi-trash"></i></button>
                        </div>
                    </td>
                </tr>
                @empty
    ...
    <div class="d-flex align-items-center justify-content-between px-4 py-3">
        <small class="text-muted">
            ...
            dari {{ $penggunas->total() }} data
        </small>
        {{-- FIX: ganti custom pagination dengan default Laravel --}}
        {{ $penggunas->links() }}
    </div>
</div>
...
@push('scripts')
<script>
const BASE_URL = '{{ route("master.pengguna.index") }}';
