...
<head>
    ...
    <title>SIMPADU – @yield('title', 'Sistem Pengaduan Kampus')</title>
...
<nav id="sidebar">
    ...
    <ul class="sidebar-nav">
        <li class="has-sub {{ request()->routeIs('master.*') ? 'open' : '' }}">
            <a href="#">
            ...
            <ul class="submenu">
                ...
                <li>
                    <a href="{{ route('master.pengguna.index') }}"
                       class="{{ request()->routeIs('master.pengguna.*') ? 'active' : '' }}">
                        Data Pengguna
                    </a>
                </li>
                <li>
                    <a href="{{ route('master.petugas.index') }}"
                       class="{{ request()->routeIs('master.petugas.*') ? 'active' : '' }}">
                        Data Petugas
                    </a>
                </li>
                <li>
                    <a href="{{ route('master.unit.index') }}"
                       class="{{ request()->routeIs('master.unit.*') ? 'active' : '' }}">
                        Unit/Bagian
                    </a>
                </li>
            </ul>
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="{{ route('pengelolaan.laporan.index') }}" class="{{ request()->routeIs('pengelolaan.laporan*') ? 'active' : '' }}"><i class="bi bi-kanban"></i> Manajemen Laporan</a>
        </li>
        <li>
            <a href="{{ route('pengelolaan.pengguna.index') }}" class="{{ request()->routeIs('pengelolaan.pengguna*') ? 'active' : '' }}"><i class="bi bi-people"></i> Manajemen Pengguna</a>
        </li>
    </ul>
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="{{ route('rekapitulasi.index') }}" class="{{ request()->routeIs('rekapitulasi.*') ? 'active' : '' }}"><i class="bi bi-bar-chart-line"></i> Rekapitulasi</a>
        </li>
        <li>
            <a href="{{ route('export.data') }}"><i class="bi bi-download"></i> Export Data</a>
        </li>
    </ul>
...
<div id="main">
    ...
    <div class="page-content">
        ...
        <div class="page-tabs">
            <a href="{{ route('master.kategori.index') }}"
               class="page-tab {{ request()->routeIs('master.kategori.*') ? 'active' : '' }}">
                <i class="bi bi-tag"></i> Kategori Pengaduan
            </a>
            <a href="{{ route('master.pengguna.index') }}"
               class="page-tab {{ request()->routeIs('master.pengguna.*') ? 'active' : '' }}">
                <i class="bi bi-person-badge"></i> Data Pengguna
            </a>
            <a href="{{ route('master.petugas.index') }}"
               class="page-tab {{ request()->routeIs('master.petugas.*') ? 'active' : '' }}">
                <i class="bi bi-person-check"></i> Data Petugas
            </a>
            <a href="{{ route('master.unit.index') }}"
               class="page-tab {{ request()->routeIs('master.unit.*') ? 'active' : '' }}">
